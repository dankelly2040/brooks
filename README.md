...
- **Exact app:** an experimental companion implementation used to push Exact's
  ...
  should improve. For now it follows `origin/main` from
  [ccheever/exact](https://github.com/ccheever/exact) rather than a pinned
  release.
...
The intended first experience mirrors the current commerce-focused website:
the Josh Kerr / Project 222 home feature, Men's, Women's, New Arrivals, Shoe
Finder, login, product shopping, and cart. Corporate and footer content can be
added later.
...
The initial benchmark set is Nike, Zappos, adidas, and GOAT. The selection and
evaluation rubric are documented in
[LLP 0001](./llp/0001-mobile-shoe-commerce-design.research.md).
...
- [LLP 0000: Brooks](./llp/0000-brooks.explainer.md) is the product and system
  entry point.
- [LLP 0001: Mobile Shoe Commerce Design Survey](./llp/0001-mobile-shoe-commerce-design.research.md)
  defines the initial native-app benchmarks and rubric.
